 ...
 * - Door locked using IR sender receiver (locked signal is low)
 * - Temperature (with Dallas temp)
 * - Battery power %
 * Difference with fronthall is the DIFFLOCKED code and ID
 *******************************  */
...
// node ID's
#define MY_NODE_ID 13             // start naming my own nodes at number 10
...
#define DIST_ID 5                 // Error count doorlock error
...
void presentation()  {
  ...
  sendSketchInfo("Side Hall Sensors", "1.2");
