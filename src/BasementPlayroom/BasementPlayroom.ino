 ...
 * - Humidity using Hum part of DHT11 (ignore temp as this is not accurate)
 * - Light sensor
 * 
...
// node IDs
#define MY_NODE_ID 24             // start naming my own nodes at number 10
...
void presentation()  {
   ...
   sendSketchInfo("Basement Playroom", "1.2"); w();
